...
# ╔═╡ 9d4d6c32-e922-11eb-19a5-0f8d58666b8c
using Luxor, Colors,PlutoUI

# ╔═╡ 6700e1d0-6a8d-49d2-9cd0-4ce1c84bae8f
@draw begin
    Luxor.text("Hello world")
    circle(Point(0, 0), 200, :stroke)
end

# ╔═╡ 1aaab1f9-a82f-4c91-8fc0-d9ca84d007aa
@draw begin
	radius=80
    setdash("dot")
    sethue("gray30")
...
# ╔═╡ f450b301-9ef8-4310-a773-48b6955ff538
@bind x Slider(0:0.1:12)

# ╔═╡ 969c28ab-288e-438e-85a6-52add80d6e0c
@bind y Slider(1:12)

# ╔═╡ 974e50b0-852e-43f3-ab89-fa95ca71a56a
@draw begin
	Luxor.setopacity(0.8)
	for i in 0:0.1:1
		sethue(HSB(360i, .8, .8))
		squircle(O, 200, 200, :fill, rt = x * i)
		rotate(2π/y)
	end
end 400 400

# ╔═╡ 00481065-14b5-4cc9-ba6d-47c0b89b6842
@draw begin
...
# ╔═╡ b7592190-a2d3-46a2-be21-d7df2d3a20ed
begin
f1 = Point(-100, 0)
f2 = Point(100, 0)
...
# ╔═╡ e44928ae-2d97-4965-a6fb-18a3d5a54b92
...
# ╔═╡ 875ee4f3-db06-4baf-8e92-099acd910412
@draw begin
